...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    "*** YOUR CODE HERE ***"
    if num_rolls == 0:
        total = tail_points(opponent_score)
    else:
...
def play(strategy0, strategy1, update,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            strate0 = strategy0(score0, score1)
            score0 = update(strate0, score0, score1, dice)
            #print(score0)
        elif who == 1:
            strate1 = strategy1(score1, score0)
            score1= update(strate1, score1, score0, dice)
            #print(score1)
        who = 1 - who 
    # END PROBLEM 5
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def blind_strategy(score, oppo_score):
        return n
...
def is_always_roll(strategy, goal=GOAL):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    pre_strategy = strategy(0, 0)
    for score in range(goal):
        for opponent_score in range(goal):
            new_strategy = strategy(score, opponent_score)
            always = (pre_strategy == new_strategy)
            if always == False:
                break
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    for num_roll in range(1, 11):
        averager = make_averaged(roll_dice, total_samples)
        current_score = averager(num_roll, dice)
        if current_score > max_score:
            max_num_roll = num_roll
...
def square_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    increased_score = square_update(0, score, opponent_score) - score
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    threshold = make_averaged(roll_dice)(6)
    num_rolls = square_strategy(score, opponent_score, threshold=threshold)
    return num_rolls
